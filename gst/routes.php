...
return $routes = [
    ...
    'verify-login-otp'           => [User::class, "verifyLoginOtp"],
    ...
    'edit-profile-update'        => [User::class, "editProfileUpdate"],
    ...
    'verify-otp'                 => [User::class, "verifyOtp"],
    'save-otp'                   => [User::class, "saveOtp"],
    'save-register-otp'          => [User::class, "saveRegisterOtp"],
